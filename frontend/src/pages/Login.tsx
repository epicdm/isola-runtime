            ...
            <div className="login-form-panel">
                ...
                <div className="login-form-wrapper">
                    ...
                    <div className="login-form-header">
                        <div className="login-form-logo"><img src="/logo-black.png" className="login-logo-img" alt="" style={{ width: 28, height: 28, marginRight: 8, verticalAlign: 'middle' }} />Isola</div>
