...
import { ALL_CHANNELS, type ChannelDef, type ChannelField, type GuideConfig } from './channelRegistry';
...
// ─── Channel Registry (R37 — filtered from shared module) ─────
const CHANNEL_REGISTRY: ChannelDef[] = ALL_CHANNELS.filter((c) => c.userSurface);
